 ...
 */
exports.application_loader = function(main) {
	this._main = main;
 ...
 * @private
 */
exports.application_loader.prototype.emit = function() {
 ...
 */
exports.application_loader.prototype.load = function(node, apps, callback) {
	var _this = this;
	var loaded_apps = [];
 ...
 * @private
 */
exports.application_loader.prototype.module_get = function(app, callback) {
	var _this = this;
 ...
 * @private
 */
exports.application_loader.prototype.app_register = function(a) {
	this.apps[a._id] = a;
 ...
 * @private
 */
exports.application_loader.prototype.app_unregister = function(a) {
 ...
 */
exports.application_loader.prototype.close = function() {
	var _this = this;
...
exports.application_loader.prototype.app_add_helper = function(config, app, settings) {
...
exports.application_loader.prototype.app_add = function(app, settings, node, config, callback) {
        // save to config:
	if (!config) {
...
exports.application_loader.prototype.app_remove = function(app) {
	if (typeof app === "string") {
		app = this.apps[app];
	}
