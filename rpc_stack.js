...
util.inherits(exports.rpcstack, EventEmitter);
 ...
 */
exports.rpcstack.prototype.register_scope = function(scope, callback) {
 ...
 */
exports.rpcstack.prototype.process_single_message = function(d, respond, module) {
	var rpc_ref = d.ref;
 ...
 * @param {object} [module] - Source module
 */
exports.rpcstack.prototype.process_message = function(messages, respond, module) {
	var r = this;
...
exports.rpcstack.prototype.unhandled_reply = function(error, message) {
	if (error !== null) {
		console.warn("RPC-Error:", error, message);
	}
};

exports.rpcstack.prototype.process_reply = function(d, module) {
...
exports.rpcstack.prototype._rpc_bind = function(cache, method, callback) {
	var ref = method;
	var ref_i = 1;
...
exports.rpcstack.prototype._rpc_bind_get = function(cache, ref) {
	var cb = false;
...
/* DEPRECATED
exports.rpcstack.prototype.rpc_reply = function(reply, ref, error, data) {
...
exports.rpcstack.prototype._rpc_process = function(method, args, reply, self, object) {
 ...
 */
exports.rpcstack.prototype._rpc_create_object = function(module, self, args) {
 ...
 */
exports.rpcstack.prototype._rpc_forwarding = function(obj, reply, node) {
